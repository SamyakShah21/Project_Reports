function patch_output = Minimum_Errror_Boundary_cut(patch_as_ref,patch_main,degree_of_overlap,type,size_patch)
...
patch_Horiz = Minimum_Errror_Boundary_cut(patch_as_ref,patch_main,degree_of_overlap,'horizontal',size_patch);
patch_output = Minimum_Errror_Boundary_cut(patch_as_ref,patch_Horiz,degree_of_overlap,'vertical',size_patch);
end
end